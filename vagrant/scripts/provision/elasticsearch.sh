...
# Taken from: https://github.com/fideloper/Vaprobash/blob/master/scripts/elasticsearch.sh

# Set some variables
ELASTICSEARCH_VERSION=1.4.1 # Check http://www.elasticsearch.org/download/ for latest version
